                ...
                >
                    <div className="container hero-content">
                        ...
                        <div className="hero-actions">
                            ...
                            <Link to="/umkm" className="btn btn-primary btn-sm">
                                Lihat UMKM
                            </Link>
                        </div>
                    </div>
            ...
            <section className="potential reveal" id="potensi">
                <div className="container">
                    <div className="section-header">
                        ...
                        <Link to="/potensi">Lihat Semua Potensi →</Link>
                    </div>
                    <div className="card-grid">
                        ...
                        <article className="info-card">
                            ...
                            <h3>Kesenian</h3>
                            <p>
                                Melestarikan budaya tradisional melalui kegiatan dan
                                pertunjukan tari.
                            </p>
                        </article>
                    </div>
                                ...
                                <article className="product-card" key={index}>
                                    ...
                                    <div className="product-body">
                                        ...
                                        <div className="product-footer">
                                            ...
                                            <button
                                                onClick={() =>
                                                    window.open(`https://wa.me/${formatWA(item.notelp)}`, "_blank")
                                                }
                                            >
